...
function Page() {
  ...
  return (
    <section className="bg-white w-full">
      <div className="flex flex-col lg:py-[120px] mx-auto lg:gap-12 max-w-[800px]">
        <div className="w-full flex flex-col gap-2">
          <h2 className="font-tomato font-bold leading-[140%] text-center text-[#12233d] lg:text-5xl">
            Join the Recreax Accelerator
          </h2>
          <p className="font-normal text-base text-center leading-[148%] font-plus-jakarta-sans text-[#65605c]">
            Reserve your spot for mentorship, funding, and growth.
          </p>
        </div>
        <form className="w-full grid grid-cols-1 lg:grid-cols-2 gap-6  font-plus-jakarta-sans">
          <InputEle
            label="Full Name"
            type="text"
            ...
            id="fullName"
            addStyle="col-span-1 lg:col-span-2"
            required
          ...
          <button
            ...
            className={`font-plus-jakarta-sans text-center items-center justify-center font-semibold text-base flex  gap-2 p-4 rounded-xl transition-all duration-300 transform hover:scale-105 col-span-2 ${
              isFormValid
      ...
      {isSubmitted && (
        <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 animate-fadeIn">
          <div className="w-full max-w-2xl rounded-2xl bg-white p-8 sm:p-12 shadow-2xl transform transition-all">
            <div className="flex flex-col items-center space-y-4">
              <svg
                className="w-16 h-16 text-green-500 mb-4 animate-checkmark"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
              ...
              <div>
                <h2 className="text-2xl sm:text-5xl text-center font-tomato text-[#12233d] font-bold leading-[140%]">
                  You&apos;re In! 🎉
                </h2>
                <p className="text-2xl sm:text-3xl text-center font-plus-jakarta-sans text-[#12233d] font-semibold leading-tight">
              ...
              <button
                onClick={() => router.push("/")}
                className="bg-[#12233d] w-full rounded-2xl text-base font-semibold  leading-[148%] font-plus-jakarta-sans text-white px-4 p-4 text-center"
              >
                Home Page
              </button>
            </div>
